CREATE TABLE employees ( id SERIAL PRIMARY KEY, name TEXT NOT NULL, department TEXT NOT NULL, google_id TEXT NOT NULL ); 
...
DROP POLICY IF EXISTS employee_department_policy ON employees;

CREATE POLICY employee_department_policy
ON employees
USING (
    google_id = current_setting('app.user_id', true)
);